...
Strategy::read( const std::string & formation_dir )
{
    ...
    std::string ETCconfigpath = configpath+"Formation/etc/";
    // before kick off
    M_before_kick_off_formation = createFormation( ETCconfigpath + BEFORE_KICK_OFF_CONF );
    ...
    ///////////////////////////////////////////////////////////
    M_normal_formation = createFormation( ETCconfigpath + NORMAL_FORMATION_CONF );
    ...
    M_defense_formation = createFormation( ETCconfigpath + DEFENSE_FORMATION_CONF );
    ...
    M_offense_formation = createFormation( ETCconfigpath + OFFENSE_FORMATION_CONF );
    ...
    M_goal_kick_opp_formation = createFormation( ETCconfigpath + GOAL_KICK_OPP_FORMATION_CONF );
    if ( ! M_goal_kick_opp_formation )
    {
        return false;
    }

    M_goal_kick_our_formation = createFormation( ETCconfigpath + GOAL_KICK_OUR_FORMATION_CONF );
    if ( ! M_goal_kick_our_formation )
    {
        return false;
    }

    M_goalie_catch_opp_formation = createFormation( ETCconfigpath + GOALIE_CATCH_OPP_FORMATION_CONF );
    if ( ! M_goalie_catch_opp_formation )
    {
        return false;
    }

    M_goalie_catch_our_formation = createFormation( ETCconfigpath + GOALIE_CATCH_OUR_FORMATION_CONF );
    if ( ! M_goalie_catch_our_formation )
    {
        return false;
    }

    M_kickin_our_formation = createFormation( ETCconfigpath + KICKIN_OUR_FORMATION_CONF );
    ...
    M_setplay_opp_formation = createFormation( ETCconfigpath + SETPLAY_OPP_FORMATION_CONF );
    ...
    M_setplay_our_formation = createFormation( ETCconfigpath + SETPLAY_OUR_FORMATION_CONF );
    ...
    M_indirect_freekick_opp_formation = createFormation( ETCconfigpath + INDIRECT_FREEKICK_OPP_FORMATION_CONF );
    ...
    M_indirect_freekick_our_formation = createFormation( ETCconfigpath + INDIRECT_FREEKICK_OUR_FORMATION_CONF );
